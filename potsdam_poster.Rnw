...
\begin{figure}
\begin{center}
\includegraphics[scale=0.99]{GUI_RKWard_1.png}
\end{center}
\end{figure}
...
\begin{block}{Summary}
The philosophy of point-of-care testing require frameworks that can be used directly at the site of patient care. The portable and self-contained \textit{dpcReport} fulfills such requirements and might be easily integrate into POCT routines involving dPCR assays.
\end{block}
\vfill
